...
{
private:
	using get_texture_with_data_type = TextureUVCoordinateSet*(*)(GrassPathBlock*, signed char, int);
	static get_texture_with_data_type get_texture_with_data_orig;
	static TextureUVCoordinateSet* get_texture_with_data_impl(GrassPathBlock* this_ptr, signed char face, int data);
